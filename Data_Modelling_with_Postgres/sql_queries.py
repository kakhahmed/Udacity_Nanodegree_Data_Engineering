...
songplay_table_insert = (
    ...
    SELECT e.start_time AT time zone 'UTC', e.user_id, e.level, e.song_id, e.artist_id,
           e.session_id, e.location, e.user_agent 
    FROM staging_events AS e JOIN stage_song AS s ON 
...
song_table_insert = (
    ...
    SELECT song_id, title, artist_id, year, duration FROM stage_song 
    """
)
